...
backup_global_assets() {
  ...
  local -a config_paths=(
    "$ETC_WEBGARDEN"
    "$NGINX_AVAILABLE_DIR/default-shkolakoda.conf"
    "$NGINX_AVAILABLE_DIR/laic.ca"
    "$NGINX_AVAILABLE_DIR/poolemergency.ca"
    "$NGINX_AVAILABLE_DIR/psyling.com"
    "$NGINX_AVAILABLE_DIR/shkolakoda.com"
    "$NGINX_AVAILABLE_DIR/tomumber.com"
    "$NGINX_ENABLED_DIR/00-default-shkolakoda.conf"
    "$NGINX_ENABLED_DIR/laic.ca"
    "$NGINX_ENABLED_DIR/poolemergency.ca"
    "$NGINX_ENABLED_DIR/psyling.com"
    "$NGINX_ENABLED_DIR/shkolakoda.com"
    "$NGINX_ENABLED_DIR/tomumber.com"
    "$SYSTEMD_UNIT_DIR/webgarden-backup.service"
    "$SYSTEMD_UNIT_DIR/webgarden-backup.timer"
    "$SYSTEMD_UNIT_DIR/webgarden-laic.service"
    "$SYSTEMD_UNIT_DIR/webgarden-poolemergency.service"
